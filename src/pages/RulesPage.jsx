...
export default function RulesPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 pt-4 pb-8">
      ...
      <Section title="Sistema de tres niveles">
        <p className="text-sm mb-3" style={{ color: 'var(--color-text-secondary)' }}>
          Por cada partido, solo el nivel más alto que alcances cuenta:
        </p>
        <div
          className="rounded-lg p-3 mb-3 text-sm"
          style={{ background: 'var(--color-surface)', color: 'var(--color-text-secondary)' }}
        >
          <p>🥉 <strong>Nivel 1:</strong> Resultado correcto (ganador o empate)</p>
          <p className="mt-1">🥈 <strong>Nivel 2:</strong> Resultado + diferencia de gol exacta</p>
          <p className="mt-1">🥇 <strong>Nivel 3:</strong> Marcador exacto (máximo puntaje)</p>
        </div>
      </Section>
      ...
      <Section title="Predicciones en Vivo (Eliminatorias)">
        ...
        >
          <p>⏰ Abre: <strong>{liveMatchTiming.opensBeforeKickoffHours}h</strong> antes del partido</p>
          <p className="mt-1">🔒 Cierra: <strong>{liveMatchTiming.locksBeforeKickoffHours}h</strong> antes del partido</p>
        </div>
      ...
      <Section title="Premios Individuales">
        <p className="text-sm mb-3" style={{ color: 'var(--color-text-secondary)' }}>
          Solo el ganador puntúa (no hay 2° o 3° lugar):
        </p>
      ...
      <Section title="Regla de los 90 Minutos">
        <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
          En partidos eliminatorios, solo cuenta el resultado al finalizar los 90 minutos
          reglamentarios. El tiempo extra y los penales <strong>no afectan</strong> las predicciones.
          Si hay empate a los 90 minutos, se considera un resultado de empate.
        </p>
      </Section>
      ...
      <Section title="Cierre de Predicciones">
        <p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>
          Las predicciones de fase de grupos y del bracket pre-torneo se cierran
          automáticamente cuando comienza el primer partido del torneo.
          Las predicciones en vivo de eliminatorias se cierran{' '}
